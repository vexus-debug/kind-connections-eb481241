...
const milestones = [
  { year: "Founded", title: "Rubi Smile Opens", desc: "Established in Karu, Abuja with a vision to provide accessible, quality dental care." },
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <SectionReveal delay={0.15}>
            ...
            <p className="font-body text-muted-foreground mt-6 leading-relaxed">
              Located in Karu, Abuja, Rubi Smile Dental Clinic was founded with a simple mission: to make quality dental care accessible, comfortable, and affordable for everyone.
            </p>
